package exemplo5.baricio.com.exemplo5.task;
...
import exemplo5.baricio.com.exemplo5.fw.Util;
...
public class LoginTask extends AsyncTask<String, Void,TOUsuario> {
    ...
    protected TOUsuario doInBackground(String... params) {
        ...
        try {
            ...
            URL url = new URL("http://apiexemplo.fourtime.com/usuarios/autenticar");
